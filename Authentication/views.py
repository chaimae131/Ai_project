...
from .forms import (
    ...
    CandidatProfileForm, CompanyProfileForm, Benefit, JobForm
)
...
from .models import Job, JobApplication
from .models import (
    Company, Job, JobApplication, Skill, CustomUser, Activity
)
...
from django.core.paginator import Paginator
from .models import (
    Skill, CandidateSkill, Job, JobApplication, Activity
)
